            ...
            if ($token) {
                ...
                if ($lastUsedAt && $now->diffInMinutes($lastUsedAt) >= $timeoutMinutes) {
                    ...
                    return response()->json([
                        'success' => false,
                        'message' => 'Session Anda telah berakhir karena tidak ada aktivitas selama 60 menit. Silakan login kembali.',
