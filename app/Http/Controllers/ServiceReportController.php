...
class ServiceReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'completed_time' => 'nullable|string|max:10',
            ...
            'ttd_teknisi' => 'nullable|string|max:500000',
        ...
        try {
            ...
            $report = ServiceReport::create([
                ...
                'completed_time' => $validated['completed_time'] ?? null,
                ...
                'ttd_teknisi' => $validated['ttd_teknisi'] ?? null,
