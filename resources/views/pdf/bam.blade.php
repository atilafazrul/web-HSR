...
<body lang="EN-US" style="word-wrap: break-word; position: relative;">
    ...
    <div class="WordSection1">
        ...
        <p class="MsoNormal" align="center" style="margin-bottom: 0in; text-align: center">
            <b><u><span lang="EN-ID" style="font-size: 18.0pt; line-height: 107%">BERITA ACARA MAINTENANCE</span></u></b>
        </p>

        <p class="MsoNormal" align="center" style="margin-bottom: 0in; text-align: center">
            <span lang="EN-ID">Nomor : {{ $nomor_surat ?? '(NOMER URUT SURAT)/BAM-HSR/BULAN ROMAWI/2026' }}</span>
        </p>
        ...
        <p class="MsoNormal" style="margin-bottom: 0in">
            <span lang="EN-ID">Pada hari ini <b>{{ $nama_hari ?? '(NAMA HARI)' }}</b> Tanggal
                <b>{{ $tanggal_bam ?? '(TANGGAL-BULAN-TAHUN)' }}</b> Telah dilaksanakan maintenance dan inspeksi, untuk peralatan di bawah ini :</span>
        </p>
        ...
        <p class="MsoNormal" style="margin-bottom: 0in">
            <span lang="EN-ID">Dengan ini kami menyatakan bahwa telah melaksanakan maintenance dan inspeksi peralatan tersebut di
