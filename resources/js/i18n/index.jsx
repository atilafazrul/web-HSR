...
const translations = {
  id: {
    ...
    settingsDesc: "Atur bahasa tampilan dan tema terang atau gelap.",
    languageDesc: "Pilih bahasa antarmuka aplikasi.",
    themeDesc: "Pilih tampilan terang atau gelap.",
  },
  en: {
    appLoading: "Loading...",
    language: "Language",
    ...
    settingsDesc: "Choose display language and light or dark theme.",
    languageDesc: "Select the application interface language.",
    themeDesc: "Choose light or dark appearance.",
  },
};
