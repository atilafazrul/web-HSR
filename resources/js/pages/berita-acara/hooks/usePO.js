...
const DEFAULT_SHIP_TO_ALAMAT =
  "Jl Raya Pasar Kemis Kp Picung RT 04/05 No. 86\nDs Pasar Kemis Kec Pasar Kemis Kab Tangerang\nBanten 15560";
...
export const usePO = (projekKerjaId = null) => {
  ...
  const estimatedPpn = Math.round(estimatedSubtotal * (Number(formData.ppn_persen || 11) / 100));
  const estimatedTotal = estimatedSubtotal + estimatedPpn;
