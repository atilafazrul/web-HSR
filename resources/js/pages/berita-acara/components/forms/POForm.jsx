      ...
      <form id="po-form" onSubmit={onSubmit} className="min-w-0">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 p-4">
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-700">{tr("Alamat Vendor", "Vendor Address")}</label>
              <textarea name="to_alamat" value={formData.to_alamat} onChange={onInputChange} rows={4} className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3" />
            </div>
          </div>
          <div className="rounded-2xl border border-slate-200 p-4">
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-700">{tr("Alamat", "Address")}</label>
              <textarea name="ship_to_alamat" value={formData.ship_to_alamat} onChange={onInputChange} rows={4} className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3" />
            </div>
          </div>
        </div>
              ...
              <div className="mb-3 grid grid-cols-1 gap-3 md:grid-cols-12">
                ...
                <div className="md:col-span-3">
                  ...
                  <input
                    ...
                    inputMode="numeric"
                    value={item.harga}
                    onChange={(e) => onItemChange(index, "harga", e.target.value)}
                    className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2.5 tabular-nums"
                    placeholder="352.200"
                    required
                  />
                </div>
