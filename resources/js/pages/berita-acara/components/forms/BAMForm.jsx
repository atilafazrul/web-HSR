      ...
      <form id="bam-form" onSubmit={onSubmit}>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-700 mb-4 pb-2 border-b flex items-center gap-2">
            ...
            {isEditing ? tr("Edit Dokumen BAM", "Edit BAM Document") : tr("Informasi Dokumen", "Document Information")}
          </h3>
        ...
        <div className="mb-8">
          ...
          {formData.items.map((item, index) => (
            <div
              key={index}
              className="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4 mb-4 items-end bg-gray-50 p-3 sm:p-4 rounded-xl"
            >
              ...
              <div className="col-span-1 sm:col-span-2">
                ...
                <input
                  ...
                  value={item.jumlah}
                  onChange={(e) =>
                    onItemChange(index, "jumlah", e.target.value)
                  }
                  placeholder="1"
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                  required
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full sm:w-auto px-6 sm:px-8 py-3 rounded-xl font-medium flex items-center justify-center gap-2 transition-all duration-200 ${
              loading
          ...
          >
            {loading ? (
              <>
                ...
                {isEditing ? tr("Menyimpan...", "Saving...") : "Generating..."}
              </>
            ) : isEditing ? (
              <>
                <Save size={20} />
