  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-3xl font-bold">{isEditing ? "Edit BAM" : "Generate BAM"}</h2>
          <p className="text-gray-500">
            {isEditing
              ? tr("Perbarui data dokumen BAM", "Update BAM document data")
              : tr("Buat dan kelola dokumen Berita Acara Maintenance", "Create and manage Maintenance Minutes documents")}
          </p>
        </div>
      </div>
